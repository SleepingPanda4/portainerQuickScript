...
#!/bin/bash   
    ...
    SERVERFILESNFSBASELOC=SERVERFILEMOUNTADDRESS:/mnt/user/ServerFiles #Insert serverfiles/PlexMedia file NFS share: Example 192.168.1.22:/mnt/users/ServerFiles
...
echo "${SERVERFILESNFSBASELOC}"
echo "${PLEXNFSBASELOC}"
echo -e "${GREEN}Mounting truenas files!${RESET}"

sudo mount -t nfs ${PLEXNFSBASELOC} /mnt/PlexMedia
sudo mount -t nfs ${SERVERFILESNFSBASELOC} /mnt/ServerFiles
# sudo mount -t nfs 192.168.1.128:/mnt/ /mnt/ServerFiles2

echo -e "${BLUE}Mounting truenas files for boot!${RESET}"
echo "${PLEXNFSBASELOC} /mnt/PlexMedia nfs4 rw,relatime 0 0
${SERVERFILESNFSBASELOC} /mnt/ServerFiles nfs4 rw,relatime 0 0" >> /etc/fstab
